...
module.exports = async (request, response) => {
 ...
 var  whitelist = ["hrichik", "Mateja"];

  var url = "https://raw.githubusercontent.com/" + user + "/"+ repo +"/"+ branch +"/"+ path;
  
if(user === "hrichik"){
       url = "https://raw.githubusercontent.com/hrichiksite/"+ repo +"/"+ branch +"/"+ path;
}
    if(user === "Mateja"){
       url = "https://raw.githubusercontent.com/MatejaSrejic/"+ repo +"/"+ branch +"/"+ path;
} 
